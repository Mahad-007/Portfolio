        ...
        >
          ...
          {experiences.map((experience, index) => {
            ...
            return (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-0 md:left-8 -translate-x-1/2 w-4 h-4 rounded-full bg-primary border-4 border-background z-10" />

                {/* Card container with offset */}
                <div className="ml-8 md:ml-20">
                  <motion.div
                    ...
                    className="group"
                  >
                    <Card className="ai-card group-hover:shadow-2xl group-hover:shadow-primary/10 hover-lift hover-glow border-l-4 border-l-primary/50">
                      <CardHeader className="pb-3">
                        <div className="flex flex-col md:flex-row md:items-start gap-3">
                          <div className={`p-2 rounded-lg bg-card border border-border/50 ${experience.color} shrink-0`}>
                            <IconComponent className="w-5 h-5" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <CardTitle className="text-base md:text-lg font-bold text-foreground group-hover:text-primary transition-colors mb-1">
                              {experience.title}
                            </CardTitle>
                            <p className="text-sm text-muted-foreground font-medium mb-2">{experience.company}</p>
